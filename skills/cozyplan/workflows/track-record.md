...
| Type | Directory | Template | ID format | Status values |
|---|---|---|---|---|
| Decision | `docs/adr/` | `templates/adr.md` | `ADR-NNNN` | proposed → accepted / rejected / superseded-by-ADR-NNNN / deprecated |
| Feature | `docs/features/` | `templates/feature.md` | `FEAT-NNN` | proposed → planned → in-development → shipped / dropped |
| Issue | `docs/issues/` | `templates/issue.md` | `ISSUE-NNN` | open → in-progress → fixed / wontfix / duplicate |

Record filenames: `<ID>-<kebab-slug>.md` (e.g. `ADR-0003-postgres-over-sqlite.md`).
