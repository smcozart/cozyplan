...
7. Report - Summarize what was built per phase, the final status of every task, and any `[f]` failures that need attention. Acceptance is not a planf3 step: open a PR and let review + merge (git, CODEOWNERS, CI) be the acceptance gate
